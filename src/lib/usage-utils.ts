 ...
 */
export function getUsagePeriodRange(period: UsagePeriod, date: Date = new Date()) {
 ...
 */
export function getPeriodDescription(period: UsagePeriod, startDate: Date, endDate: Date): string {
