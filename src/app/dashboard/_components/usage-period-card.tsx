...
import { formatUsageHours, getPeriodDescription, getPeriodDisplayName } from "@/lib/usage-utils";
...
export function UsagePeriodCard({ data, className = "" }: UsagePeriodCardProps) {
  const { period, dateRange, totalBookings, totalHours, activeBookings, completedBookings } = data;
